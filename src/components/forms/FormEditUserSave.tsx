...
export interface FormEditUserSaveHandles {
  saveEditedSource: () => void;
  resetForm: () => void;
}

const FormEditUserSave = forwardRef<FormEditUserSaveHandles, Props> (({ onClose, showFormButtons = true, data }, ref) => {
...
export default FormEditUserSave;
