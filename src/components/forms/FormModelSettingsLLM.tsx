...
export interface FormModelSettingsLLMHandles {
  saveEditedModel: () => Promise<boolean>;
  resetForm: () => void;
}

const FormModelSettingsLLM = forwardRef<FormModelSettingsLLMHandles, Props>(({ onClose, showFormButtons = false, data, onSaveData }, ref) => {
...
export default FormModelSettingsLLM;
