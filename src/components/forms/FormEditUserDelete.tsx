...
export interface FormEditUserDeleteHandles {
  deleteSource: () => void;
}

const FormEditUserDelete = forwardRef<FormEditUserDeleteHandles, Props>(({ onClose, showFormButtons = true, data }, ref) => {
...
export default FormEditUserDelete;
