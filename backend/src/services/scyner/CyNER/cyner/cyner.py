...
class CyNER(): 
    def __init__(self, transformers_config, use_heuristic=True, flair_model='ner', spacy_model=None, priority='HTFS'):
        self.transformer_ner = eef.get_entity_extraction_model('transformers', transformers_config)
